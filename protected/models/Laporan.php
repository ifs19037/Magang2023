 ...
 * @property string $keterangan_laporan
 */
class Laporan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama_laporan, keterangan_laporan', 'required'),
			array('nama_laporan, keterangan_laporan', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_laporan, nama_laporan, keterangan_laporan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'keterangan_laporan' => 'Keterangan Laporan',
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('keterangan_laporan',$this->keterangan_laporan,true);
