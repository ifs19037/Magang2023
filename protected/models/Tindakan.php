...
class Tindakan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('nama_tindakan, keterangan_tindakan', 'required'),
			array('nama_tindakan, keterangan_tindakan', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_tindakan, nama_tindakan, keterangan_tindakan', 'safe', 'on'=>'search'),
		);
	}
